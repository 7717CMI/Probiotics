      ...
      <Grid container spacing={2} sx={{ mb: "20px" }}>
        <Grid item xs={12} sm={6} md={3}>
          <Box sx={{ backgroundColor: colors.primary[400], padding: "20px", borderRadius: "8px" }}>
            <StatBox title={kpis.totalRevenue} subtitle="Total Revenue" icon={<MedicationOutlinedIcon sx={{ color: colors.greenAccent[600], fontSize: "26px" }} />} progress="0.75" />
          </Box>
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <Box sx={{ backgroundColor: colors.primary[400], padding: "20px", borderRadius: "8px" }}>
            <StatBox title={kpis.topBrand} subtitle="Top Performing Brand" icon={<MedicationOutlinedIcon sx={{ color: colors.greenAccent[600], fontSize: "26px" }} />} progress="0.70" />
          </Box>
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <Box sx={{ backgroundColor: colors.primary[400], padding: "20px", borderRadius: "8px" }}>
            <StatBox title={kpis.topAgeGroup} subtitle="Top Age Group" icon={<MedicationOutlinedIcon sx={{ color: colors.greenAccent[600], fontSize: "26px" }} />} progress="0.60" />
          </Box>
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <Box sx={{ backgroundColor: colors.primary[400], padding: "20px", borderRadius: "8px" }}>
            <StatBox title={kpis.avgRevenue} subtitle="Avg Revenue per Brand" icon={<MedicationOutlinedIcon sx={{ color: colors.greenAccent[600], fontSize: "26px" }} />} progress="0.65" />
          </Box>
        </Grid>
      </Grid>
